  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-primary text-primary-foreground py-16 group">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg opacity-90 max-w-3xl transition-transform duration-300 group-hover:scale-105">
            Мы - гордые студенты РТУ МИРЭА и очень любим дисциплину "Создание программного обеспечения"
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center group cursor-default">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/10 rounded-full mb-4
              ...
              <Clock className="w-8 h-8 text-primary transition-transform duration-300 group-hover:scale-110" />
            </div>
            <h3 className="text-xl font-semibold mb-2 transition-transform duration-300 group-hover:scale-105">1 год</h3>
            <p className="text-muted-foreground transition-transform duration-300 group-hover:scale-105">на рынке автомобилей</p>
          </div>
          ...
          <div className="text-center group cursor-default">
            ...
            <h3 className="text-xl font-semibold mb-2 transition-transform duration-300 group-hover:scale-105">100+</h3>
            <p className="text-muted-foreground transition-transform duration-300 group-hover:scale-105">довольных клиентов</p>
          </div>
          ...
          <div className="text-center group cursor-default">
            ...
            <h3 className="text-xl font-semibold mb-2 transition-transform duration-300 group-hover:scale-105">100%</h3>
            <p className="text-muted-foreground transition-transform duration-300 group-hover:scale-105">проверенные автомобили</p>
          </div>
          ...
          <div className="text-center group cursor-default">
            ...
            <h3 className="text-xl font-semibold mb-2 transition-transform duration-300 group-hover:scale-105">Лучший</h3>
            <p className="text-muted-foreground transition-transform duration-300 group-hover:scale-105">автосалон 2026 года</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 group">
        <div className="text-center mb-12"> {/* Уменьшил mb-16 → mb-12 для компактности */}
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto transition-transform duration-300 group-hover:scale-105">
            Познакомьтесь с разработчиками, которые создавали этот проект с любовью к коду и дисциплине «Создание ПО»
          </p>
        </div>

        <div className="overflow-x-auto pb-8"> {/* Уменьшил pb-12 → pb-8 */}
          <div className="grid grid-cols-6 gap-x-[60px] gap-y-[80px] min-w-[800px] max-w-6xl mx-auto">
            {[teamMembers[0], teamMembers[3], teamMembers[4]].map((member) => (
              ...
              >
                <div className="w-44 h-44 rounded-full bg-secondary mx-auto mb-4 overflow-hidden /* mb-6 → mb-4 */
